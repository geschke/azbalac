...
?>
 ...
 <div role="tabpanel" class="tab-pane fade show active" id="azbalac-tab-getting-started">
        ...
        <h1 class="azbalac-welcome-title"><?php _e('Welcome to Azbalac theme!', 'azbalac'); ?> 
            <?php
	...
	<div class="azbalac-tab-pane-half azbalac-tab-pane-first-half">
		<h3><?php esc_html_e( 'About Azbalac theme', 'azbalac' ); ?></h3>
	...
	<div class="azbalac-tab-pane-half">
		...
		<h3><?php esc_html_e( 'Feedback and Support', 'azbalac' ); ?></h3>
                <p><?php esc_html_e( 'The theme is actively maintained and developed. But due to the history it didn\'t try to implement all imaginable WordPress features. And there is no "pro" or "enhanced" or "commercial" version, no upgrade option or soomething else - and there will never be!', 'azbalac' ); ?></p>
                <p>
                <?php esc_html_e( 'The Azbalac theme will stay free, with every feature which will be added in future. I have some features in mind, and if there is enough time maybe I will implement them.', 'azbalac' ); ?></p>
                <p>
